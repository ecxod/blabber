...
public class MagicCreateActivity extends XmppActivity implements TextWatcher, AdapterView.OnItemSelectedListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (data != null) {
            final String requestedDomain = data.getStringExtra(EXTRA_DOMAIN);
            final boolean validRegistrationDomain = Config.REGISTRATION_DOMAIN.equalsIgnoreCase(requestedDomain);
            this.domain = Config.REGISTRATION_DOMAIN;
            this.preAuth = validRegistrationDomain ? data.getStringExtra(EXTRA_PRE_AUTH) : null;
            this.username = validRegistrationDomain ? data.getStringExtra(EXTRA_USERNAME) : null;
            this.registerFromUri = validRegistrationDomain && data.getBooleanExtra(EXTRA_REGISTER, false);
        } else {
            this.domain = Config.REGISTRATION_DOMAIN;
            this.preAuth = null;
            this.username = null;
        ...
        domains.add(Config.REGISTRATION_DOMAIN);
    ...
    private String updateDomain() {
        return Config.REGISTRATION_DOMAIN;
    }
