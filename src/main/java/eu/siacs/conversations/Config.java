...
public final class Config {
    ...
    public static final String CHANGELOG_URL = "https://github.com/ecxod/blabber/blob/master/CHANGELOG.md";
    public static final String GIT_URL = "https://github.com/ecxod/blabber/";
    ...
    public static final String REGISTRATION_DOMAIN = "xmpp.de";
    public static final String MAGIC_CREATE_DOMAIN = REGISTRATION_DOMAIN;
    ...
    public static final int QUOTE_MAX_DEPTH = 7; // How deep nested quotes should be displayed. '2' means one quote nested in another.
    public static final int QUOTING_MAX_DEPTH = 2; // How deep nested quotes should be created on quoting a message.
